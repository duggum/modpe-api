...
exports.publish = function(taffyData, opts, tutorials) {
  ...
  classes().each(function(rec) {
    metadata.code.classes[rec.name] = rec.description || '';
  });
  modules().each(function(rec) {
    metadata.code.modules[rec.name] = rec.description || '';
  });
  namespaces().each(function(rec) {
    metadata.code.namespaces[rec.name] = rec.description || '';
  });
  mixins().each(function(rec) {
    metadata.code.mixins[rec.name] = rec.description || '';
  });
  externals().each(function(rec) {
    metadata.code.externals[rec.name] = rec.description || '';
  });
