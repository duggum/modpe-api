...
if (env.conf.templates.meta) {
  if (env.conf.templates.meta.description) { ?>
    <meta name="description" content="<?js= env.conf.templates.meta.description ?>" />
<?js
  }
  if (env.conf.templates.meta.keyword) { ?>
...
<![endif]-->
    ...
    <link type="text/css" rel="stylesheet" href="css/modpe_api_icons.css">
  ...
  <body>
    <div id="wrap" class="clearfix">
      ...
      <div class="main">
        ...
        <?js= content ?>
        <footer>
          <p><a href="https://github.com/duggum/modpe-api">ModPE API Documentation</a> &copy; <span id="cyear">2015</span> <a href="https://duggum.com">David Jopson</a></p>
          <p>Generated by <a href="https://github.com/jsdoc3/jsdoc">JSDoc <?js= env.version.number ?></a> :: <?js= (new Date().toDateString()) ?></p>
    ...
    <script type="text/javascript">
      hljs.configure({ tabReplace: "  ", languages: [ "javascript" ] });
      hljs.initHighlightingOnLoad();
    </script>
    <script type="text/javascript">
      window.onload = function() { document.getElementById("cyear").innerHTML = new Date().getFullYear(); };
    </script>
  </body>
</html>
